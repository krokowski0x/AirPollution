...
const runSetup = () => {
  ...
  .then(response => {
    ...
    const airPollutionUrl = `https://airapi.airly.eu/v1/nearestSensor/measurements?latitude=${response.latitude}&longitude=${response.longitude}&maxDistance=10000`;
      ...
      .prompt([
        {
          ...
          type: 'list',
          message: `Is ${response.address.route}, ${response.address.locality}, ${response.address.country} near your location?`,
          choices: [
            'Yes',
            'No'
          ],
